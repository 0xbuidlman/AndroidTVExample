...
public class PlayerActivity extends Activity {
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        new RetrieveFeedTask(new RetrieveFeedTask.Callback() {
            ...
            public void onSuccess(List<Channel> list) {
                PlayerActivity.this.channelList = list;
            }
    ...
    private void startVideoPlayer() {
        ...
        mSelectedChannel = (Channel) getIntent().getSerializableExtra(getResources().getString(R.string.channel));
        if (null != b) {
            ...
            mVideoView.setVideoPath(mSelectedChannel.getVideoUrl());
        ...
        public void run() {
            mHandler.post(new Runnable() {
                ...
                public void run() {
                    ...
                    intent.putExtra(getResources().getString(R.string.channel), mSelectedChannel);
...
//        }
        ...
        switch (keyCode) {
            ...
            case KeyEvent.KEYCODE_DPAD_LEFT:
                ...
                index = channelList.indexOf(mSelectedChannel);
                if (index <= 0){
                    mSelectedChannel = channelList.get(channelList.size()-1);
                } else {
                    mSelectedChannel = channelList.get(index -1);
                }
                mVideoView.stopPlayback();
                mVideoView.setVideoPath(mSelectedChannel.getVideoUrl());
                mVideoView.start();
...
//                    play(currentPos);
            ...
            case KeyEvent.KEYCODE_DPAD_RIGHT:
                ...
                if (index >= channelList.size() -1){
                    mSelectedChannel = channelList.get(0);
                } else {
                    mSelectedChannel = channelList.get(index+1);
                }
                mVideoView.stopPlayback();
